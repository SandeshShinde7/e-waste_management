...
if (strlen($_SESSION['pgasaid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    $mobno=$_POST['phone'];
     ...
     $query=mysqli_query($con, "update admin set name='$aname', phone='$mobno' where ID='$adminid'");
     echo $query;
    if ($query) {
...
?>
                                <form class="cmxform form-horizontal " method="post" action="">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="phone" name="phone" type="text" value="<?php  echo $row['phone'];?>" required="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control " id="email" name="email" type="email" value="<?php  echo $row['mail'];?>" required="true" readonly='true'>
                                        </div>
                                    </div>
                                    <?php } ?>
