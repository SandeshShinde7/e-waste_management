...
$query=mysqli_query($con,"select ID from admin where ID='$adminid' and pass='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update admin set pass='$newpassword' where ID='$adminid'");
